...
import com.example.hp.androideat.ViewHolder.OrderViewHolder;
...
public class OrderStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadOrders(Common.currentUser.getNama());

    }

    private void loadOrders(String nama) {

        adapter = new FirebaseRecyclerAdapter<Request, OrderViewHolder>(
                Request.class,
                R.layout.order_layout,
                OrderViewHolder.class,
                request.orderByChild("name")
                .equalTo(nama)
        ) {
            @Override
            protected void populateViewHolder(OrderViewHolder viewHolder, Request model, int position) {
                ...
                viewHolder.txtOrderTable.setText(model.getName());
            }
        };
